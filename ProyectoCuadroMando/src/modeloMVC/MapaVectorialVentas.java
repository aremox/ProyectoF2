...
public class MapaVectorialVentas extends MapaVectorialBase implements IMapaRepresentarEntidades, IMapaRepresentarAsociacion {

    public MapaVectorialVentas() {
        super();
        //incializar contexto de dibujo
       grafico2d.setPaint(Color.DARK_GRAY);//color de la línea rojo
    }
