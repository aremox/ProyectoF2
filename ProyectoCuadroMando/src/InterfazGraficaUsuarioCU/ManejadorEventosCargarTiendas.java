...
public class ManejadorEventosCargarTiendas implements Action {
    ...
    public ManejadorEventosCargarTiendas(PanelCargarTiendas objeto, PanelGeneralOpciones objeto2){
        panel = objeto;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ("Seleccionar archivo".equals(boton.getText())) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null,"Archivo de TIENDAS cargado correctamente                  ","RESULTADO DE LA CARGA       ", JOptionPane.INFORMATION_MESSAGE);
                panel.setTextCuadroTextoRuta("");
                panel.setEnabledBotonCargar(Boolean.FALSE);
